<?php
    ...
    <body class="font-[VT323] bg-[url('../images/gray.jpg')]">
        <nav class="bg-transparent backdrop-blur-lg border-2 sticky top-0 flex justify-between py-[0.2rem] items-center px-[5rem] z-10">
            ...
            <div class="flex gap-8 text-black text-[1.2rem]">
                <a href="home.php" class="group transition-all duration-300">
                ...
                <a href="ticket.php" class="group transition-all duration-300">
                    <span class="bg-left-bottom bg-gradient-to-r from-black to-black bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-300 ease-out">
                        Ticket
                </a>
                <a href="profile.php" class="group transition-all duration-300">
                    <span class="bg-left-bottom bg-gradient-to-r from-black to-black bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-300 ease-out">
                        Profile
                </a>
                <a href="contact.php" class="group transition-all duration-300">
                    <span class="bg-left-bottom bg-gradient-to-r from-black to-black bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-300 ease-out">
                        Contact Us
                </a>
        ...
        <div class="bg-light bg-[url('../images/gray.jpg')]" style="">
                                ...
                                <div class="container-fluid">
                                    <form action="save_schedule.php" method="post" id="schedule-form">
                                        ...
                                        <div class="form-group mb-2">
                                            ...
                                            <select class="form-control form-control-sm rounded-0" name="service_type" id="service_type" required>
                                        ...
                                        <div class="form-group mb-2 opacity-0">
    ...
    <script>
        // Get references to the start and end datetime inputs
        const startInput = document.getElementById('start_datetime');
        const endInput = document.getElementById('end_datetime');

        // Add an event listener to the start input
        startInput.addEventListener('input', function() {
            // Set the value of the end input to match the value of the start input
